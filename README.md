...
<p align="center">
  ...
  <a href="LICENSE"><img src="https://img.shields.io/badge/license-MIT-8a1b16?style=flat-square" alt="MIT License"></a>
  <img src="https://img.shields.io/badge/agent-skill-c52424?style=flat-square" alt="Agent Skill">
</p>

# 跟党学 Coding/ 辩证思维 Skill
...
**本 skill 不涉及政治宣传，**关注的是一套能进入实际工作的思维工具：抓主要矛盾、坚持具体问题具体分析、先调查再判断、从实践中修正认识。

搜索别名：`辩证唯物主义`、`跟党学Coding`、`mao-dialectics`、`Mao Dialectics for Coding`、`Mao Dialectics for AI Agents`。
